...
// Any time the object is serialized, we store the path provided by this Asset
// (assuming it was valid).
// 
...
// 
// It is up to the user to ensure the scene exists in the build settings
// so it is loadable at runtime.
...
//          This only happens the fist time, and reverting again fixes it.
